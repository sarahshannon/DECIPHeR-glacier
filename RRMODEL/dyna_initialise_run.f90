...
contains
    ...
    subroutine initialise_run (dyna_hru, &
        ...
        dyna_hru%sum_aeout  = 0.0
        dyna_hru%sum_pptin  = 0.0
        dyna_hru%sum_pein   = 0.0

        dyna_hru%sumexs     = 0.0
        dyna_hru%sumexus    = 0.0

        dyna_riv%sumqb      = 0.0
        dyna_riv%sumqout    = 0.0
        dyna_riv%sumqof     = 0.0

        dyna_hru%snowdepth  = 0.0
        dyna_hru%snowtemp   = 0.0
        dyna_hru%snowmelt   = 0.0
        dyna_hru%liquid     = 0.0
        dyna_hru%solid      = 0.0
