...
contains
    ...
    subroutine mc_setup (ACC, &
        ...
        character(len=20), dimension(nparam),intent(out) :: all_pm_names !names of all possible parameters - must be added to if new params are developed!
        type(dyna_hru_type), dimension(:), allocatable :: dyna_hru

        ! Local Declares
        character(len=20), dimension(nparam) :: all_pm_names_ll !names of all possible parameters followed by ll (lower limit)
        character(len=20), dimension(nparam) :: all_pm_names_ul !names of all possible parameters followed by ul (upper limit)
        double precision, dimension(nparam) :: all_pm_declared  !logical check all essential parameters have been included in param file
        integer :: i, j
        ...
        all_pm_names(8) = "max_ddf_snow_def"
        all_pm_names(9) = "ddf_scale_snow_def"
        all_pm_names(10) = "tlapse_def"
        all_pm_names(11) = "plapse_def"
        all_pm_names(12) = "rain2snow_temp_def"
        all_pm_names(13) = "melt_temp_def"
        all_pm_names(14) = "tlag_snow_def"
        all_pm_names(15) = "tlag_ice_scale_def"
        all_pm_names(16) = "ddf_ice_scale_def"
        all_pm_names(17) = "snow2ice_def"
        all_pm_names(18) = "snow_ice_sublim_def"
        all_pm_names(19) = "rcf_def"
        all_pm_names(20) = "scf_def"
        ...
        all_pm_names_ll(8) = "max_ddf_snow_ll"
        all_pm_names_ll(9) = "ddf_scale_snow_ll"
        all_pm_names_ll(10) = "tlapse_ll"
        all_pm_names_ll(11) = "plapse_ll"
        all_pm_names_ll(12) = "rain2snow_temp_ll"
        all_pm_names_ll(13) = "melt_temp_ll"
        all_pm_names_ll(14) = "tlag_snow_ll"
        all_pm_names_ll(15) = "tlag_ice_scale_ll"
        all_pm_names_ll(16) = "ddf_ice_scale_ll"
        all_pm_names_ll(17) = "snow2ice_ll"
        all_pm_names_ll(18) = "snow_ice_sublim_ll"
        all_pm_names_ll(19) = "rcf_ll"
        all_pm_names_ll(20) = "scf_ll"
        ...
        all_pm_names_ul(8) = "max_ddf_snow_ul"
        all_pm_names_ul(9) = "ddf_scale_snow_ul"
        all_pm_names_ul(10) = "tlapse_ul"
        all_pm_names_ul(11) = "plapse_ul"
        all_pm_names_ul(12) = "rain2snow_temp_ul"
        all_pm_names_ul(13) = "melt_temp_ul"
        all_pm_names_ul(14) = "tlag_snow_ul"
        all_pm_names_ul(15) = "tlag_ice_scale_ul"
        all_pm_names_ul(16) = "ddf_ice_scale_ul"
        all_pm_names_ul(17) = "snow2ice_ul"
        all_pm_names_ul(18) = "snow_ice_sublim_ul"
        all_pm_names_ul(19) = "rcf_ul"
        all_pm_names_ul(20) = "scf_ul"
        ...
        print *, 'num_par_types', num_par_types
        if (sum(all_pm_declared(1:nparam)) < nparam) then
            !print *, sum(all_pm_declared(1:nparam))
