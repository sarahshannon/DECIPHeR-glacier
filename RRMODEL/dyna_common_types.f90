module dyna_common_types
    ...
    type dyna_hru_type
        ...
        doubleprecision :: elev_climate
        doubleprecision :: elev
        doubleprecision :: snowdepth
        doubleprecision :: snowtemp
        doubleprecision :: snowmelt
        doubleprecision :: liquid
        doubleprecision :: solid
        
        !---static glacier varibles
        doubleprecision :: glaciertemp
        doubleprecision :: glacierdepth
        doubleprecision :: glaciermelt
        doubleprecision :: glacierdepth_old
        doubleprecision :: snowdepth_old
        doubleprecision :: delta_glacierdepth
        doubleprecision :: delta_snowdepth
        doubleprecision :: init_glacierdepth
        doubleprecision :: smb
        doubleprecision :: h_flux
